...
namespace ContactList.Application.Contracts.Repositories.Query.Base
{
    public interface IQueryRepository<TEntity> where TEntity : class
    {
        ...
        /// <param name="isProcedure"></param>
        /// <returns></returns>
        Task<IEnumerable<TEntity>> GetAsync<TFirst, TSecond, TThird, TFourth, TFifth, TEntity>(string sql, Func<TFirst, TSecond, TThird, TFourth, TFifth, TEntity> map, DynamicParameters parameters, string splitters, bool isProcedure = false)
            where TFirst : class
            where TSecond : class
            where TThird : class
            where TFourth : class
